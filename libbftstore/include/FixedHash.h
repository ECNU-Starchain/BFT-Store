...
public:
    ...
    explicit FixedHash(std::string const& _s, ConstructFromStringType _t = FromHex,
      ...
      : FixedHash(_t == FromHex ? fromHex(_s, WhenError::Throw) : ec::asBytes(_s), _ht)
    {}
...
namespace std
{
/// Forward std::hash<ec::FixedHash> to ec::FixedHash::hash.
template <>
struct hash<ec::h64> : ec::h64::hash
{
};
template <>
struct hash<ec::h128> : ec::h128::hash
{
};
template <>
struct hash<ec::h160> : ec::h160::hash
{
};
template <>
struct hash<ec::h256> : ec::h256::hash
{
};
template <>
struct hash<ec::h512> : ec::h512::hash
{
};
}  // namespace std
